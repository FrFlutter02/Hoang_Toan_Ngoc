...
class _ForgotPasswordPageState extends State<ForgotPasswordPage> {
  ...
  Widget build(BuildContext context) {
    ...
    double iconAndTopSpacing = heightScreen * 0.3 / 8.12;
    ...
    double resetPasswordTextSpacing = heightScreen * 0.45 / 8.12;
    ...
    double heightButton = heightScreen * 0.55 / 8.12;
              ...
              children: [
                ...
                Text(
                  ...
                  style: Theme.of(context).textTheme.subtitle2?.copyWith(
                      color: Color(AppForgotPasswordPage.emailTextColor)),
                ),
